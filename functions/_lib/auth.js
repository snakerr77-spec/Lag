...
export function normalizeRole(value) {
  ...
  const allowed = new Set(["admin", "administrador", "gestor", "gerente", "financeiro", "laboratorio", "colaborador", "dev"]);
 ...
 * O e-mail só é exposto em rotas autenticadas de administração/conta.
 * Hash e salt de senha nunca são retornados.
 */
