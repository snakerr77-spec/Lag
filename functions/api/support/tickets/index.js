...
export async function onRequestPost(context) {
  ...
  try {
    ...
    await context.env.DB.prepare(`INSERT INTO support_tickets (
      ...
      .bind(ticket.id, ticket.userId, ticket.userName, ticket.userEmail, ticket.role, ticket.city, ticket.module, ticket.moduleLabel, ticket.issue, ticket.urgency, ticket.description, ticket.pageTitle, ticket.pageUrl, ticket.browser, ticket.createdAt, ticket.updatedAt)
      .run();
