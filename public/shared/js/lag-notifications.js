(() => {
  ...
  function resolveHref(href) {
    ...
    // Gestão e metas deve sempre abrir a página correta,
    // independentemente do módulo em que a notificação foi exibida.
    if (cleanHref === "gestao/index.html" || cleanHref.endsWith("/gestao/index.html")) {
      return location.protocol === "file:" ? "../gestao/index.html" : "/gestao/index.html";
    }
